package com.iadeva.guardrails.support;
 ...
 *
 * Usado para testar os componentes Spring AI (GuardrailsService, ResilientChatClient,
 * SafeguardOrchestrator, ChatController) apontando {@code spring.ai.openai.base-url} para
...
public final class MockOpenAiServer implements AutoCloseable {
    ...
    /** Extrai o conteúdo da última mensagem enviada em "messages" (usado para rotear por conteúdo). */
    @SuppressWarnings("unchecked")
    public static String lastMessageContent(Map<String, Object> body) {
