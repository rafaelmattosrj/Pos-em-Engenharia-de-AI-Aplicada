...
// AllMiniLmL6V2EmbeddingModel (ONNX in-process) da versao Java, ja que Go
// nao tem um binding ONNX Runtime conveniente sem cgo. Usando o modelo
// "all-minilm" servido localmente pelo Ollama, o resultado continua 100%
// local, sem chamada de API paga nem internet — apenas a forma de hospedar
// o modelo muda (processo separado via HTTP, em vez de in-process). Mesmo
// pacote/padrao reaproveitado de pdf-rag-knowledge-base-go e
...
// Dimension e a dimensionalidade do vetor produzido pelo modelo all-minilm
// (mesma dimensao do all-MiniLM-L6-v2 usado na versao Java).
const Dimension = 384
